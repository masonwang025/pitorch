...
int main(void) {
     ...
     * ──────────────────────────────────────────────────────────── */
    long full_sz;
    void *full_data = pt_read_file("../../weights/stories42M.bin", &full_sz);
    ...
    const char *shard_paths[NUM_RANKS] = {
        "../../weights/shards/42M/rank0.bin",
        "../../weights/shards/42M/rank1.bin",
        "../../weights/shards/42M/rank2.bin",
        "../../weights/shards/42M/rank3.bin",
    };
